...
# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    # Odoo Store Specific
    'images': ['static/description/Cancel & Reset - Sales, Purchases and Pickings Cover.jpg'],  
    ...
    'application': True,
    'auto_install': False,
    'live_test_url': 'http://www.emiprotechnologies.com/free-trial?app=all-in-one-cancel-reset-ept&version=12&edition=enterprise',
    'currency': 'EUR',
}
