...
class PurchaseOrderLine(models.Model):
	...
	def _get_price_reduce(self):
		for line in self:
			...
			line.line_sub_total = line.product_qty * line.price_unit
		
	price_reduce = fields.Float(compute='_get_price_reduce', string='Reduccion de Precio', readonly=True, store=True, digits=(12,4))
	line_sub_total = fields.Monetary(compute='_get_price_reduce', string='Subtotal de Linea', store=True)
